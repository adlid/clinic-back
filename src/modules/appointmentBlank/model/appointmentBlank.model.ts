...
import {
    TreatmentPlan,
    TreatmentPlanGraph,
} from './treatment/treatment_plan.model';
...
export class AppointmentBlankGraph {
    ...
    @Field(() => TreatmentPlanGraph, { nullable: true })
    treatmentPlan?: TreatmentPlanGraph;
    ...
    constructor(args: AppointmentBlankArg) {
        ...
        if (args.treatmentPlan != null)
            this.treatmentPlan = new TreatmentPlanGraph({
                ...args.treatmentPlan,
            });
    }
}
